...
- Passer en vue la gestion des chronologies
- Permettre d'uploader de plus grandes bannières
- Changer l'affichage de la bannière principale

### Fixed

- Corriger le dropdown categorie et portails quand les noms sont trop longs

### Removed

- Enlever les pages de détails d'un tag et les listings des types qui font doublons avec les filtres des pages de recherche
...
- Ajout de boutons supplémentaires dans la barre d'accès rapide et le menu contextuel de l'éditeur

### Fixed

- Taille de la modal de l'éditeur, trop petite, notamment pour les réglages tableaux
...
- Corriger l'erreur à la suppression d'un portail s'il a des éléments associés 
- Corriger l'erreur 500 à la soumission d'un formulaire de section non valide

## [2.6.1] - 2024-02-02

### Changed

- Désactiver la réécriture d'url dans l'éditeur
- Ajouter la section déplacer à la fin de la liste des sections de son nouvel article

### Fixed

- Rendre l'éditeur compatible avec xhtml pour la génération de fichier word

### Removed

- Retirer la classe figure
